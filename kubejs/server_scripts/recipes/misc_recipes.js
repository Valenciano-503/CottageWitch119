ServerEvents.recipes((event) => {
	...
	//Necklace Tier 2
	event.shapeless(Item.of("crittersandcompanions:pearl_necklace_2"), [
		"crittersandcompanions:pearl_necklace_1", //
		"minecraft:ender_pearl",
	]);

	//Necklace Tier 3
	event.shapeless(Item.of("crittersandcompanions:pearl_necklace_3"), [
		"crittersandcompanions:pearl_necklace_2", //
		"mermod:glowing_pearl_modifier",
	]);

	//Mermod Moon Rock Uses Moon Dust
	event.shapeless(Item.of("mermod:moon_rock_modifier"), [
		"#forge:cobblestone", //
		"hexerei:moon_dust",
		"minecraft:black_dye",
	]);
	...
	event.shapeless(Item.of("minecraft:ender_pearl", 4), [
		"#forge:eyes", //
	]);
	...
	// Mermod Sea Crystal
	event.shapeless(Item.of("mermod:sea_crystal", 4), [
		"endrem:guardian_eye", //
	...
	event.shapeless(Item.of("spelunkery:coal_lump", 9), [
		"minecraft:coal", //
	]);
	event.shapeless(Item.of("minecraft:coal"), [
	...
	event.shapeless(Item.of("minecraft:coal", 9), [
		"minecraft:coal_block", //
	]);

	//compress and uncompress eggs
	event.shapeless(Item.of("prefab:item_carton_of_eggs"), [
		"minecraft:egg", //
		"minecraft:egg",
		"minecraft:egg",
		"minecraft:egg",
	...
	event.shapeless(Item.of("minecraft:egg", 9), [
	...
	// Portable Jukebox
	event.shapeless(Item.of("portablejukebox:portable_jukebox"), [
		"minecraft:jukebox", //
		"portablejukebox:portable_note_block",
	]);

	// hexerei stone window
	event.shapeless(Item.of("hexerei:stone_window", 2), [
		"#forge:stone", //
		"#forge:glass",
	]);
	...
	for (const fish of aquaFish) {
		event
			.shapeless(Item.of(fish + "_bucket"), [
				fish, //
	...
	event.shapeless(Item.of("minecraft:bone_meal"), [
	...
	event.shapeless(Item.of("byg:peat"), ["ecologics:surface_moss", "minecraft:dirt"]);

	event.shapeless(Item.of("byg:lush_dirt"), ["minecraft:bone_meal", "minecraft:dirt"]);
	...
	// misc stonecutting
	event.stonecutting(
		"ars_scalaes:smooth_sourcestone_wall",
		"ars_nouveau:smooth_sourcestone"
	);
	event.stonecutting(
		"ars_scalaes:smooth_sourcestone_stairs",
		"ars_nouveau:smooth_sourcestone"
	);
	...
	const counters = [
		...
		"luphieclutteredmod:luphie_cat_counter_a",
		"luphieclutteredmod:luphie_cat_kitchen_counter_b",
		"luphieclutteredmod:luphie_sweetheart_counter_a",
		"luphieclutteredmod:luphie_sweetheart_counter_b",
		"luphieclutteredmod:luphie_white_counter",
		"luphieclutteredmod:luphie_pink_counter",
		"luphieclutteredmod:luphie_yellow_counter",
		"luphieclutteredmod:luphie_light_green_counter",
		"luphieclutteredmod:luphie_black_counter",
	];
